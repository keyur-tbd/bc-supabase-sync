...
Refreshing the data is a different thing and is scheduled: `.github/workflows/o2c_refresh.yml` calls
`select public.o2c_refresh()` twice a day (09:00 and 18:00 IST). Run it by hand from the Actions tab
after a GRN backfill.
